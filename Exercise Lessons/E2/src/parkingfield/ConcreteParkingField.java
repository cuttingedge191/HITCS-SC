...
public class ConcreteParkingField implements ParkingField {
	 ...
	 */
	public ConcreteParkingField(String name, int[] lotnos, int[] width) {
		this.name = name;
		//this.lotsNumber=lotnos.length;
	...
	public Set<Integer> getLots(){
		...
		return reSet;  //存在表示泄露
		//return Collections.unmodifiableSet(reSet);
	}
	...
	public String toString() {
		...
		SortedSet<Lot> sortedLots=new TreeSet<Lot>(new lotComparator()); //按照车位号排序
