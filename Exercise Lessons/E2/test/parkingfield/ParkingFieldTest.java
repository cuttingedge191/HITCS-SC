...
public class ParkingFieldTest {
	...
	@Test
	public void testCreate() throws NoSuchLotException {
		String pfName="A1";
		final int width[]= {200,180,200,170,190};
		final int lotnos[]={1,2,3,4,5};
		ParkingField pf = ParkingField.create(pfName,lotnos,width);
	...
	@Test
	public void testDepart() throws CarNotInFieldException
	{
		// 生成1个停车场
		String pfName = "A1";
		final int width[] = { 200, 180, 200, 170, 220 };
	...
	@Test
	public void testRecords() throws ParkingFieldFullException, CarAlreadyParkingException, LotOccupiedException, NoSuchLotException, LotTooNarrowException, InterruptedException, CarNotInFieldException{
		// 生成1个停车场
		String pfName = "A1";
		final int width[] = { 200, 180, 200, 170, 220 };
		final int lotnos[] = { 1, 2, 3, 4, 5 };
		...
		TimeUnit.SECONDS.sleep(1); // 根据需要执行若干时间
		pf.depart(plateNo2);
		for (Record re:pf.records()) {
